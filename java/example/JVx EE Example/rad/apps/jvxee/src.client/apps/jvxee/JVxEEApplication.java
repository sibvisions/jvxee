...
public class JVxEEApplication extends Application {
	   ...
	   */
	   ...
	   protected void afterLogin()
	   {
	     ...
	     UIMenuItem miJPAEdit = createMenuItem
	                           ("doOpenFrame", null, "Customer Edit", 
	     ...
	     UIButton butJPAEdit = createToolBarButton
	                          ("doOpenFrame", null, "Customer Edit", 
	                           UIImage.getImage(UIImage.SEARCH_LARGE));
