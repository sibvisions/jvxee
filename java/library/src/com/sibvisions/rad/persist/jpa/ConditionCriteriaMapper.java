...
public class ConditionCriteriaMapper {
	...
	JPAServerMetaData serverMetaData;
	...
	public ConditionCriteriaMapper(JPAServerMetaData pServerMetaData, CriteriaBuilder pCriteriaBuilder) {
		this.serverMetaData = pServerMetaData;
		this.criteriaBuilder = pCriteriaBuilder;
	}
	 ...
	 * @param fromEntity the Entity to select
	 ...
	 */
	public CriteriaQuery getCriteriaQuery(ICondition pCondition, SortDefinition pSort, Class fromEntity, String pJoinAttributeName) throws DataSourceException {
		
		CriteriaQuery criteriaQuery = criteriaBuilder.createQuery();
		From from = criteriaQuery.from(fromEntity);
		
		if(pCondition != null) {
				
			if(pJoinAttributeName != null) { // Is a ManyToMany Relationship
...
//				JPAForeignKey jpaForeignKey = serverMetaData.getJPAForeignKeyForCondition(pCondition);
	 ...
	 * @throws DataSourceException throws a DataSourceException when the defined Columns are not in the ServerMetaData
	 */
	public CriteriaQuery getCountCriteriaQuery(ICondition pCondition, Class fromEntity, String pJoinAttributeName) throws DataSourceException {
	 ...
	 * @throws DataSourceException throws a DataSourceException when the defined Columns are not in the ServerMetaData
	 */
	private Predicate getPredicateForOperatorCondition(OperatorCondition pOperatorCondition, From from) throws DataSourceException {
		...
		for(ICondition subCondition : pOperatorCondition.getConditions()) {
			...
			if(subCondition instanceof OperatorCondition) {
				predicate = getPredicateForOperatorCondition((OperatorCondition) subCondition, from);
			} else if(subCondition instanceof CompareCondition) {
				predicate = getPredicateForCompareCondition((CompareCondition) subCondition, from);				
			} else if(subCondition instanceof Not) {
				predicate = getPredicateForNotCondition((Not) subCondition, from);
			}
	 ...
	 * @throws DataSourceException throws a DataSourceException when the defined Columns are not in the ServerMetaData
	 */
	private Predicate getPredicateForNotCondition(Not pNotCondition, From from) throws DataSourceException {
		...
		if(inNot instanceof OperatorCondition) {
			...
			predicate = getPredicateForOperatorCondition((OperatorCondition) inNot, from); 
			
		} else if(inNot instanceof CompareCondition) {
			
			predicate = getPredicateForCompareCondition((CompareCondition) inNot, from);
			
		} else if(inNot instanceof Not) {
			
			predicate = getPredicateForNotCondition((Not) inNot, from);
		}
	 ...
	 * @throws DataSourceException throws a DataSourceException when the defined Columns are not in the ServerMetaData
	 */
	private Predicate getPredicateForCompareCondition(CompareCondition pCompareCondition, From from) throws DataSourceException {
		...
		if(pCompareCondition instanceof Equals) {
			...
			if(value == null) {
				...
				path = from.get(serverColumnMetaData.getJPAMappingType().getPathNavigation().get(0));
			...
			if(value instanceof java.lang.Byte) {
				...
				predicate = criteriaBuilder.greaterThan(path, (java.lang.Byte) value);

			} else if(value instanceof java.lang.Short) {
				
				predicate = criteriaBuilder.greaterThan(path, (java.lang.Short) value);

			} else if(value instanceof java.lang.Integer) {
				
				predicate = criteriaBuilder.greaterThan(path, (java.lang.Integer) value);

			} else  if(value instanceof java.lang.Long) {
				
				predicate = criteriaBuilder.greaterThan(path, (java.lang.Long) value);

			} else if(value instanceof java.lang.Float) {
				
				predicate = criteriaBuilder.greaterThan(path, (java.lang.Float) value);

			} else if(value instanceof java.lang.Double) {
				
				predicate = criteriaBuilder.greaterThan(path, (java.lang.Double) value);
			...
			if(value instanceof java.lang.Byte) {
				...
				predicate = criteriaBuilder.greaterThanOrEqualTo(path, (java.lang.Byte) value);

			} else if(value instanceof java.lang.Short) {
				
				predicate = criteriaBuilder.greaterThanOrEqualTo(path, (java.lang.Short) value);

			} else if(value instanceof java.lang.Integer) {
				
				predicate = criteriaBuilder.greaterThanOrEqualTo(path, (java.lang.Integer) value);

			} else  if(value instanceof java.lang.Long) {
				
				predicate = criteriaBuilder.greaterThanOrEqualTo(path, (java.lang.Long) value);

			} else if(value instanceof java.lang.Float) {
				
				predicate = criteriaBuilder.greaterThanOrEqualTo(path, (java.lang.Float) value);

			} else if(value instanceof java.lang.Double) {
				
				predicate = criteriaBuilder.greaterThanOrEqualTo(path, (java.lang.Double) value);
			...
			if(value instanceof java.lang.Byte) {
				...
				predicate = criteriaBuilder.lessThan(path, (java.lang.Byte) value);

			} else if(value instanceof java.lang.Short) {
				
				predicate = criteriaBuilder.lessThan(path, (java.lang.Short) value);

			} else if(value instanceof java.lang.Integer) {
				
				predicate = criteriaBuilder.lessThan(path, (java.lang.Integer) value);

			} else  if(value instanceof java.lang.Long) {
				
				predicate = criteriaBuilder.lessThan(path, (java.lang.Long) value);

			} else if(value instanceof java.lang.Float) {
				
				predicate = criteriaBuilder.lessThan(path, (java.lang.Float) value);

			} else if(value instanceof java.lang.Double) {
				
				predicate = criteriaBuilder.lessThan(path, (java.lang.Double) value);
			...
			if(value instanceof java.lang.Byte) {
				...
				predicate = criteriaBuilder.lessThanOrEqualTo(path, (java.lang.Byte) value);

			} else if(value instanceof java.lang.Short) {
				
				predicate = criteriaBuilder.lessThanOrEqualTo(path, (java.lang.Short) value);

			} else if(value instanceof java.lang.Integer) {
				
				predicate = criteriaBuilder.lessThanOrEqualTo(path, (java.lang.Integer) value);

			} else  if(value instanceof java.lang.Long) {
				
				predicate = criteriaBuilder.lessThanOrEqualTo(path, (java.lang.Long) value);

			} else if(value instanceof java.lang.Float) {
				
				predicate = criteriaBuilder.lessThanOrEqualTo(path, (java.lang.Float) value);
	 ...
	 */
	public void setOrdering(CriteriaQuery criteriaQuery, From from, SortDefinition pSort) throws DataSourceException {
