 ...
 * @author Stefan Wurm
 */
public class CustomerFrame extends UIInternalFrame {
	...
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	  ...
	  private static final String NO_IMAGE = "/apps/jvxeee/images/nobody.gif";
	  ...
	  /**
	   * Creates a new instance of CustomerFrame for a specific application.
	   * <p/>
	   * @param pApp the application
	   * @throws Throwable if the remote access fails
	   */
	  public CustomerFrame(Application pApp) throws Throwable {
	  ...
	  private void initializeModel() throws Throwable {
	    ...
	    connection = ((MasterConnection)application.getConnection()).
	                 createSubConnection("apps.jvxee.frames.JPAEdit");
	    connection.open();
		...
		UIChoiceCellEditor editor = new UIChoiceCellEditor(new Object [] {true, false}, new String [] {UIImage.CHECK_YES_SMALL, UIImage.CHECK_SMALL}, UIImage.CHECK_SMALL);
		...
		public void doFilter() throws ModelException {
			...
			if (suche == null) {
				...
				ICondition filter = new LikeIgnoreCase("FIRSTNAME", "*" + suche + "*").or(
									...
									new LikeIgnoreCase("EMAIL", "*" + suche + "*")));
